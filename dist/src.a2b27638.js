...
var coppiedPerson = _objectSpread({}, person); // { name: "John", lastname: "Doe", age: 50} => H00XC03
...
var test = "Soy un test";
var testTwo = "Soy otro test";
testTwo = " Soy el test número dos"; // test = "Soy el test número uno";
...
Object.freeze(subject); // subject.name = "Desarrollo Web";
...
var mappedPeople = [].concat(people).map(function (person) {
  return person.name = "C. ".concat(person.name);
});
var filterPeople = [].concat(people).filter(function (person) {
  return person.age > 18;
});
console.log(people, mappedPeople, filterPeople); // Ejercicio
